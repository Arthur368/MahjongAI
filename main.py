...
def run_example_ai(drawer=None):
    ...
    user = "ID044813EF-4dCn98J3"      # the user ID that you got after having registered in tenhou.net
    user_name = "MyBot"      # the user name that you have created while registration in tenhou.net
...
def run_Arthur_ai(drawer=None):
    # the OBJECT of your own implemented Mahjong agent
    ai_module = importlib.import_module("agents.arthurAI")
    ai_class = getattr(ai_module, "ArthurAIv1")
    ai_obj = ai_class()
    ...
    connect_and_play(ai_obj, opponent_class, user, user_name, '0', game_type, logger_obj,drawer)
