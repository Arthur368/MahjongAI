...
class TenhouClient:
    ...
    def _get(self):
        msgs = ""
        try:
            msgs = self.skt.recv(4096).decode('utf-8')#make some change
    ...
    def _buffer_log(self, msg):
        self.logger_obj.buffer_mode and self.logger_obj.logger_buffer.append(msg)# made some change

    def _stream_log(self, msg):
        (not self.logger_obj.buffer_mode) and self.logger_obj.add_line(msg)#made some change
